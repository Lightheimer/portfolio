...
const PROJECTS: Project[] = [
  {
    slug: "https://thecut-omega.vercel.app",
    index: "01",
    title: "The Cut",
    subtitle: "Maison de coiffure . Lome",
    context: "Reservations en ligne, suivi de coupe en temps reel, boutique, espace coiffeurs et caisse. Application complete livree au client, en production.",
    year: "2026",
    stack: "Next.js 16 . Prisma . PostgreSQL",
    status: { label: "En production", tone: "live" },
    image: "/work/thecut.jpg",
    alt: "The Cut, maison de coiffure a Lome, reservation en ligne",
  },
  {
    slug: "https://suzy-theta.vercel.app",
    index: "02",
    title: "Suzy",
    subtitle: "Friperie premium . Lome",
    context: "Vitrine e-commerce de pieces uniques : catalogue, commande en ligne, confirmation WhatsApp, admin complete. Chaque piece n'existe qu'une fois.",
    year: "2026",
    stack: "Next.js 16 . Prisma . PostgreSQL",
    status: { label: "En ligne", tone: "live" },
    image: "/work/suzy.jpg",
    alt: "Suzy, friperie premium en ligne a Lome",
  },
  {
    slug: "https://serenity-black.vercel.app",
    index: "03",
    title: "Serenity",
    subtitle: "Atelier de design & developpement",
    context: "Site manifeste de mon atelier : direction artistique, animations sur mesure, bilingue FR/EN. La vitrine de la pratique elle-meme.",
    year: "2026",
    stack: "Next.js 16 . Motion . Tailwind v4",
    status: { label: "En ligne", tone: "live" },
    image: "/work/serenity.jpg",
    alt: "Serenity, atelier de design et developpement",
  },
  {
    ...
    context: "Plateforme de gestion locative meublee courte / longue duree. En production depuis janvier 2026, une seule maintenance corrective depuis le lancement.",
    year: "2026",
  ...
  },
  {
    ...
    context: "Plateforme de gestion du courrier de l'Assemblee Nationale Togolaise. Developpee pendant le stage UNICEF Togo, demo validee par les parties prenantes, mise en production en preparation.",
    year: "2026",
    stack: "Laravel . Livewire . MySQL",
    status: { label: "En finalisation", tone: "wip" },
  ...
  },
  {
    ...
    context: "Boutique en ligne, catalogue, panier, paiement WhatsApp. Geree en autonomie par la proprietaire depuis la livraison.",
    year: "2026",
    stack: "Laravel . Livewire . MySQL",
    status: { label: "En ligne", tone: "live" },
